        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-4 gap-3 mb-4">
            {[0, 1, 2, 3, 4, 5, 6].map((runs) => (
              <button
                ...
                className={`h-16 rounded-lg font-bold text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed ${runs === 0
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            <button
              ...
              className="h-12 bg-yellow-600 hover:bg-yellow-700 disabled:bg-yellow-800 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-all flex items-center justify-center"
            >
              {undoLoading ? (
...
function PlayerPanel({ onClose, striker, nonStriker, bowler, setStriker, setNonStriker, setBowler, setBallHistory, battingTeamPlayers, bowlingTeamPlayers, battingTeam, bowlingTeam, switchTeams, setCurrentBall }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 mb-15">

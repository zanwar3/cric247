      ...
      <div className="min-h-screen bg-slate-900">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">Manage your cricket profile and details</p>
            </div>
            <button
        ...
        <div className="p-4">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 mb-6 text-center">
            ...
            <p className="text-slate-400 capitalize">{userProfile.position}</p>
            {editing && (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="text-slate-300">{userProfile.dateOfBirth || "Not provided"}</p>
                )}
              </div>
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="text-slate-300">{userProfile.phone || "Not provided"}</p>
                )}
              </div>
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="text-slate-300">{userProfile.location || "Not provided"}</p>
                )}
              </div>
            </div>
          </div>
